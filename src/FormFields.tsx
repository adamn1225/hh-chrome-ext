    ...
    return (
        <>
            <div className='flex gap-1 items-start justify-center w-full'>
                <label className="text-gray-950 font-medium text-sm">Year
                    <input
                        type="text"
                        placeholder="Year"
                        value={year}
                ...
                <label className="text-gray-950 font-medium text-sm">Make
                    <input
                        type="text"
                        placeholder="Make"
                        value={make}
                ...
                <label className="text-gray-950 font-medium text-sm">Model
                    <input
                        type="text"
                        placeholder="Model"
                        value={model}
